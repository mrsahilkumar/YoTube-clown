  ...
  return (
    <Link to="/video/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://i.ytimg.com/vi/t6MeeKrDIlM/maxresdefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>Sanju: KAR HAR MAIDAAN FATEH Full Audio | Ranbir Kapoor | Rajkumar Hirani</Title>
            <ChannelName>T-series</ChannelName>
            <Info>14M views  5 years ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>
