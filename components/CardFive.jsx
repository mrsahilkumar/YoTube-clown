  ...
  return (
    <Link to="/videotwo/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://i.ytimg.com/vi/05TA9jNnCdU/maxresdefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>Jagga Jasoos: Galti Se Mistake Video Song | Ranbir, Katrina | Pritam, Arijit, Amit | Amitabh B</Title>
            <ChannelName>T-series</ChannelName>
            <Info>897M views  6 years ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>
