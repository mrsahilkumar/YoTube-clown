  ...
  return (
    <Link to="/videotwo/test" style={{ textDecoration: "none" }}>
      <Container type={type}>
        <Image
          type={type}
          src="https://i.ytimg.com/vi/BddP6PYo2gs/maxresdefault.jpg"
        />
        <Details type={type}>
          <ChannelImage
            type={type}
          ...
          />
          <Texts>
            <Title>Kesariya - Brahmāstra | Ranbir Kapoor | Alia Bhatt | Pritam | Arijit Singh | Amitabh Bhattacharya</Title>
            <ChannelName>T-series</ChannelName>
            <Info>513M views  1 year ago</Info>
          </Texts>
        </Details>
      </Container>
    </Link>
